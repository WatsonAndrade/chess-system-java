...
public class ChessMatch {
	...
	private ChessPiece enPassantVulnerarble;
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if(movedPiece instanceof Pawn && (target.getRow() == source.getRow() -2 || target.getRow() == source.getRow() +2)) {
			enPassantVulnerarble = movedPiece;
		}
		else {
			enPassantVulnerarble = null;
		}
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		//SPECIALMOVE EN PASSANT
				if (p instanceof Pawn) {
					if(source.getColumn() != target.getColumn() && capturedPiece == enPassantVulnerarble) {
	...
	private void validateSourcePosition(Position position) {
		if (!board.thereIsAPiece(position)) {
			throw new ChessException("Nao existe peca da posiçao de origem");
		}
